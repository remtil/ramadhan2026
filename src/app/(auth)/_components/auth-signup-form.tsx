...
import { type SignUpInput, signUpSchema } from "@/lib/validations/schemas/auth";
...
export function AuthSignUpForm() {
	...
	async function onSubmit(data: SignUpInput) {
		...
		if (!parsed.success) {
			...
			if (flat.name) setFormError("name", { message: flat.name[0] });
			if (flat.email) setFormError("email", { message: flat.email[0] });
			return;
		}
	...
	return (
		...
		>
			...
			<div className="space-y-2">
				<Label htmlFor="signup-name" className="text-neutral-700 font-medium">
					Nama
				</Label>
				<Input
					id="signup-name"
			...
			<div className="space-y-2">
				<Label htmlFor="signup-email" className="text-neutral-700 font-medium">
					Email
				</Label>
				<Input
					id="signup-email"
